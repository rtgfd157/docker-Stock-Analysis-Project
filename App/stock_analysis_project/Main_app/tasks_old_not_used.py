...
def make(companies_obj):
    ...
    """
    #print(" number of companies from make function: ", companies_obj.count()) - npdata need special print
    above_2 =0
    today = datetime.today()
    ...
    #for com in companies_obj:
        ...
        some_var = 0 # counter
        print("$$$$ com.ticker- ",com)
        
        
        print(" args abc :",str(day_after_10_days)," ", str(l))
