...
# @shared_task
# class  Celery_Task_Updating_Stockdaydata:
#     """
...
#     def __init__(self,companies_obj_in):
#         self.companies_obj = companies_obj_in
...
#         n = 10
#         l = numpy.array_split(numpy.array(self.companies_obj),n)
